// for문 연습: 외부 JS파일 - for_ex.js

// JS외부파일은 html문서에 직접들어가 작동되므로 css처럼 'utf-8' 같은
// 인코딩 설정이 필요없음
// !
...
function insertMini() {
    ...
    console.log('전체개수 확인: ', count_min, typeof count_mini);
    //typeof 변수 -> 변수의 데이터형 출력

    // 출력대상: .stxt span -> cnt_spot 변수
    //미니언즈가 
    cnt_spot.innerText = count_min * 3;
